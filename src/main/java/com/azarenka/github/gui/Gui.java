package com.azarenka.github.gui;
...
public class Gui {
    ...
    private final String imageName = "Fa-Team-Fontawesome-Brands-FontAwesome-Brands-Square-Git.32.png";

    public Gui() {
        try {
            SystemTray tray = SystemTray.getSystemTray();
            Image image = Toolkit.getDefaultToolkit()
                    .createImage(getClass().getResource(imageName));
